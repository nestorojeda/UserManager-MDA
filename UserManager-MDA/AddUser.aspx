    ...
    <div class="row min-vh-100 justify-content-center align-content-center">
        <div class="col-6 py-3">
              ...
              <div class="form-group row mx-0">
                ...
                <select runat="server" class="form-control col-12" id="CategorySelectInput">
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>
              ...
              <div class="form-check row mx-0 pb-3">
                  ...
                  <label class="form-check-label" runat="server"for="adminCheck">Solicitud de administrador</label>
              </div>  
              <div class="form-group row mx-0">
              ...
              <div class="custom-file row mx-0">
                <input type="file" runat="server" class="custom-file-input col-12" id="FileInput" lang="es">
                <label class="custom-file-label col-12" for="FileInput">Seleccionar Archivo</label>
              </div>
              <button type="submit" runat="server" class="btn btn-primary mt-3">Add User</button>
